...
describe('locale', () => {
  ...
  it('日本語ロケールに必要なキーがすべて含まれていること', () => {
    const requiredKeys = [
      'app', 'about', 'setting', 'services', 'hide', 'hideOthers', 'quit',
      'file', 'openDir', 'new', 'duplicate', 'search', 'searchFullText', 'close',
      'edit', 'cut', 'copy', 'paste', 'pasteAndMatchStyle', 'delete', 'selectAll',
      'speak', 'startSpeaking', 'stopSpeaking', 'view', 'sidebar', 'zoomIn',
      'zoomOut', 'toggleDevTools', 'resetZoom', 'togglefullscreen', 'window',
      'minimize', 'zoom', 'front', 'help', 'github', 'openInDefaultApp',
      'revealInFinder', 'copyPath', 'copyPrompt', 'backLink', 'copyAll'
    ]
